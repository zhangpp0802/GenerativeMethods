...
class Face {
	...
	update(p, t, dt) {
		...
		this.skinBase.setTo((this.aof.get("color")*255),
			20 + 86*this.aof.get("shade"),
			30 + 68*this.aof.get("shade"))

		let w = this.faceSize*this.aof.get("width")*2 + 0.7
		let h = this.faceSize*this.aof.get("height")*2 + 0.7
...
Face.labels = ["chin", "jaw", "chinWidth", "cheekAngle", "color", "shade", "width", "height", "eyeAngle", "eyeColor"]
