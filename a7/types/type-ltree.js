...
class LTree {
	...
	update(p, t, dt) {
		...
		this.root.energy = this.aof.get("energy")
...
LTree.labels = ["spread", "energy", "bushiness", "length_dieoff", "thickness_dieoff", "flowerHue", "petalSpread", "flowerSize", "flowerSpikiness"]
